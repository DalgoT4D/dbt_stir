...
with initial_merge as ({{ dbt_utils.union_relations(
    relations=[ref('dev_classroom_surveys_uganda'),ref('dev_classroom_surveys_indonesia'), ref('dev_classroom_surveys_delhi'), ref('dev_classroom_surveys_tamil_nadu'), ref('dev_classroom_surveys_karnataka'), ref('dev_classroom_surveys_ethiopia')],
