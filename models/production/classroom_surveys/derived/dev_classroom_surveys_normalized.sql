...
with merged_normalized AS
       (SELECT "KEY","submissiondate","observation_date","country","region","sub_region","forms", "forms_verbose", "observation_term","meeting",
...
FROM {{ref('dev_classroom_surveys_merged')}}
)
