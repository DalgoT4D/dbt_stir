...
with merged_normalized AS (SELECT "KEY","submissiondate","country","region","sub_region","forms","observation_term","meeting",
       unnest(array['s1','s2','s3','s4','c1','c2','e1','e2','se1','se2','se3','se4','se5','cc1','cc2', 'cc3', 'cc4', 'cc5','ad1', 'ad2', 'ad3', 'ad4', 'ad5', 'ad6','ad7', 'ad8', 'ad9','sr1', 'sr2', 'sr3', 'sr4', 'sr5', 'sr6','cro13']) AS subindicator,
       unnest(array[s1,s2,s3,s4,c1,c2,e1,e2,se1,se2,se3,se4,se5,cc1,cc2,cc3, cc4,cc5,ad1, ad2, ad3, ad4, ad5, ad6,ad7, ad8, ad9,sr1, sr2, sr3, sr4, sr5, sr6,cro13]) AS score
...
WHEN subindicator IN ('cro13') THEN 'CRO13'
