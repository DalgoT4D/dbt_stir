...
merged_normalized AS (
    ...
    SELECT
        ...
        UNNEST ( ARRAY[
            CASE WHEN btrim(coalesce(s1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(s1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(s2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(s2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(s3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(s3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(s4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(s4::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(c1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(c1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(c2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(c2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(c3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(c3::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(e1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(e1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(e2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(e2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(e3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(e3::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(se1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(se1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(se2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(se2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(se3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(se3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(se4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(se4::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(se5::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(se5::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(cc1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(cc1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(cc2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(cc2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(cc3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(cc3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(cc4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(cc4::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(cc5::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(cc5::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(gc1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(gc1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(gc2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(gc2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(gc3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(gc3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(gc4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(gc4::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(gc5::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(gc5::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(ad1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad4::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad5::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad5::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad7::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad7::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad8::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad8::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(ad9::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(ad9::text)::numeric)::bigint END,

            CASE WHEN btrim(coalesce(sr1::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr1::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(sr2::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr2::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(sr3::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr3::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(sr4::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr4::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(sr5::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr5::text)::numeric)::bigint END,
            CASE WHEN btrim(coalesce(sr6::text, '')) ~ '^-?\d+\.?\d*$' THEN (btrim(sr6::text)::numeric)::bigint END,
