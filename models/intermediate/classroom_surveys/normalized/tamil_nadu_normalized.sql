...
SELECT 
    ...
    _airbyte_meta
    -- Extra TN fields retained as comments:
    -- cro13aiv_classroom_routines, n5_sece, cro13aiv_structuring_learning_journey,
    -- n_seca, n_secc, n4_sece, review_status, "CompletionDate",
    -- e3, cro6, n1, n2, n3, n4, n1_sece, cro13aiv_na,
FROM {{ source('source_classroom_surveys_new', 'tn_data') }}
