...
-- Indonesia_SCTO schema: KEY and SubmissionDate from source (like Uganda/TN/Karnataka); no _id, n*, _tags, cro13a_* variants
...
-- KEY and SubmissionDate are included from source (aligned with Tamil Nadu/Karnataka/Uganda pattern).
...
surveycto_data AS (
    SELECT
        ...
        ) AS "KEY",  -- KEY from source, prefixed for uniqueness (like TN/Karnataka/Uganda)
        c1a, c2a,
        cc1, cc2, cc3, cc4, cc5,
        ...
        CAST(NULL AS varchar) AS cro13av,
        endtime, meeting,
        ...
        "SubmissionDate",  -- SubmissionDate from source (like TN/Karnataka/Uganda)
...
kobo_data AS (
    SELECT
        ...
        coach_gender_specify, coachee_gender_specify,
        remarks_group_coaching,
        -- cro13a variant columns now use underscores (not slashes) in Kobo
