...
{{ dbt_utils.star(from= ref('dev_staging_indonesia'), except=['district_kota_kediri', 'location_indonesia', 'district_indonesia', 's1', 's2', 's3', 'e1', 'e2','c1', 'c1a', 'c2', 'c2a', 'c3', 'se1', 'se2', 'se3', 'date', 'date_coaching','starttime','endtime','submissiondate','"CompletionDate"', '_airbyte_indonesia_stir_bm_2022_hashid']) }},
...
from {{ ref('dev_staging_indonesia') }}
