...
select
forms,
{{ dbt_utils.star(from= ref('dev_staging_karnataka'), except=['forms', 'district_kt', 'date', 'date_coaching','starttime','endtime','submissiondate','"CompletionDate"', '_airbyte_karnataka_stir_bm_2022_hashid']) }},
...
from {{ ref("dev_staging_karnataka") }}
